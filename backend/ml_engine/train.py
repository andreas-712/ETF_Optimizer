...
from ml_engine.predictor import SECTOR_FEATURE_COLUMNS, add_sector_features
...
def _build_gemini_feature_frame(
    ...
    Sector is optional metadata. When present, it is converted to one-hot columns.
    """
    ...
    # 3. Map each ticker to its respective sector
    result = add_sector_features(result)
